...
//	@SuppressWarnings({"rawtypes","unchecked"})
    ...
    public ServletRegistrationBean<MessageDispatcherServlet> messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean<>(servlet, "/apiService/*");
    }
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema employeeSchema) {
        ...
        wsdl11Definition.setLocationUri("/apiService");
        wsdl11Definition.setTargetNamespace("http://com.api.Soap.entittes");
